...
(function () {
  ...
  // real pdf.js render scale and affected pages are re-rendered at the new
  // resolution as they come back into view.
  ...
  function onTouchEnd(e) {
    ...
    if (Math.abs(ratio - 1) < 0.01) return; // effectively just a tap-through, no real pinch
    ...
    pageWrappers.forEach((w) => {
      w.rendered = false;
      w.el.innerHTML = "";
      w.el.style.height = parseFloat(w.el.style.height || "0") * ratio + "px";
    });
